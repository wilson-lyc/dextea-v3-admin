...
export const CUSTOMIZATION_STATUS_LABEL: Record<number, string> = {
  [CUSTOMIZATION_STATUS.OFF.value]: "下架",
  [CUSTOMIZATION_STATUS.ON.value]: "启用",
}

export const CUSTOMIZATION_STATUS_TEXT_CLASSES: Record<CustomizationStatus, string> = {
...
export const CUSTOMIZATION_STATUS_BADGE_CLASSES: Record<
  CustomizationStatus,
  string
> = {
