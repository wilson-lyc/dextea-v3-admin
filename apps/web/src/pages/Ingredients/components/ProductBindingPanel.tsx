...
import { getIngredientBoundProducts, bindProductToIngredient, updateIngredientProductQuantity, unbindProductFromIngredient } from "@/services"
          ...
          <Dialog open={bindOpen} onOpenChange={setBindOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>输入商品ID和用量即可将商品绑定到该原料</DialogDescription>
              </DialogHeader>
              <div className="flex flex-col gap-4 py-2">
                <div className="flex flex-col gap-1.5">
                  <label className="text-sm font-medium">商品ID <span className="text-red-500">*</span></label>
                  <Input
                    placeholder="输入商品ID"
                    value={bindProductId}
