...
export const CreateIngredientResponseSchema = z.object({
  id: z.number(),
});
...
export const UpdateIngredientResponseSchema = z.object({
  id: z.number(),
});
...
export const UpdateIngredientStatusRequestSchema = z.object({
  status: z.number(),
});
