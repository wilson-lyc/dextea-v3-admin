...
export const IngredientErrorCodes = {
  ...
  PRODUCT_ALREADY_BOUND: { code: 11008, message: '该商品已绑定此原料' },
  BIND_NOT_FOUND: { code: 11009, message: '绑定关系不存在' },
  PRODUCT_NOT_FOUND: { code: 11010, message: '商品不存在' },
  BIND_LIST_FAILED: { code: 11011, message: '获取绑定商品列表失败' },
  ...
  OPTION_BOUND_TO_OTHER_INGREDIENT: { code: 11022, message: '该客制化选项已绑定到其他原料，无法改派' },
